import { ArrowRight, CheckCircle2, Globe, MessageSquare, PhoneCall, Zap, Target, Shield, TrendingUp, Play, Lock } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Card className="p-8 border-2 border-gray-200 hover:border-blue-400 transition-all hover:shadow-2xl bg-white">
                <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl overflow-hidden mb-6 aspect-video flex items-center justify-center group cursor-pointer">
                  {/* Video Placeholder */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 bg-blue-50 border-l-4 border-blue-600 p-4 rounded mt-6">
                    ...
                    <p className="text-sm text-gray-700">
                      <span className="font-semibold">Proprietary Content:</span> This video contains confidential information and is for authorized viewers only.
                    </p>
                  </div>
                </div>
              </Card>
